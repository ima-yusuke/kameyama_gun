<x-app-layout>
    ...
    <!--modal -->
    <div id="bullet_edit_modal" class="hidden fixed top-1/2 transform -translate-y-1/2 inset-0 z-50 flex justify-center items-center w-full h-[70%] overflow-y-scroll">
        <div class="relative p-4 w-[80%] h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 w-full">
                ...
                <div class="p-4 md:p-5 space-y-4 w-full">
                    <form enctype="multipart/form-data" method="post" action="{{route("admin.bullet.update")}}"  class="w-[90%] flex flex-col gap-2">
                        @csrf
                        {{--品名--}}
                        ...
                        <x-dash-form-component :flag="false" title="料金">
                            <input type="number" id="bullet_modal_price"  placeholder="例）3000" name="price" class="rounded-lg">
                        </x-dash-form-component>
                        {{--備考欄--}}
