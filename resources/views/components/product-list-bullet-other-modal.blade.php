...
<div id="bullet_other_modal" class="hidden fixed inset-0 z-50 flex justify-center items-center min-h-screen">
    <div class="relative p-4 w-full max-w-2xl max-h-[70%] overflow-y-scroll">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                ...
                {{--閉じるボタン--}}
                <button onclick="CloseBulletOtherModal()" type="button" id="modal-close-btn" class="text-red-500 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="static-modal">
            ...
            <div class="p-4 md:p-5 space-y-4">
                <aside class="flex flex-col md:flex-row md:flex-wrap gap-8 w-full">
                    {{--品番--}}
