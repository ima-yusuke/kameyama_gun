<nav x-data="{ open: false }" class="bg-[#E5DDCE]" >
    ...
    <div class="lg:hidden w-full flex justify-end relative z-50">
        <button
            @click="open = !open"
    ...
    <!-- PC用メニュー（md以上で表示） -->
    <ul class="bg-[#E5DDCE] hidden lg:flex justify-around">
    ...
    <nav
        ...
        class="fixed top-0 right-0 w-[85%] h-full bg-[#E5DDCE] shadow-lg lg:hidden z-40"
    >
